        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    first_name = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false, defaultValue: ""),
                    last_name = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false, defaultValue: ""),
                    patronymic = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false, defaultValue: ""),
                    email = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false, defaultValue: ""),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_employees_AspNetUsers_application_user_id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    customer_company = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false, defaultValue: ""),
                    contractor_company = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false, defaultValue: ""),
                    priority = table.Column<byte>(type: "INTEGER", nullable: false, defaultValue: (byte)0),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_project_employee_employees_employee_id",
                        column: x => x.employee_id,
                        principalTable: "employees",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_project_employee_projects_project_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_project_tasks_employees_AssigneeId",
                        column: x => x.AssigneeId,
                        principalTable: "employees",
                        principalColumn: "id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_project_tasks_employees_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "employees",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
